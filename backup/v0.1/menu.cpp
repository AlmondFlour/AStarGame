...
int Menu::checkClicked( float x, float y )
{
    ...
    //float adjustedX =  ( x - ( display.left * window->getSize().x ) ) / display.width;
    //float adjustedY =  ( y - ( display.top * window->getSize().y ) ) / display.height;
    ...
    {
        /*
        std::cout << "X: " << menuItems[n].boundaries.left << ", " << adjustedCoords.x
            << ", " << menuItems[n].boundaries.left + menuItems[n].boundaries.width << "\n"
            << "Y: " << menuItems[n].boundaries.top << ", " << adjustedCoords.y
            << ", " << menuItems[n].boundaries.top + menuItems[n].boundaries.height << "\n\n";
        */
